...
Abra la imagen \directory{CSKS3\_GEC\_B\_S2\_03\_HH\_RD\_SF\_20141221211655\_20141221211703.h5} de la carpeta \directory{material>raster\_data>COSMO}. Despliege la banda \directory{Sigma\_HH\_db}.
...
Abra la imagen \path{SENTINEL} de la carpeta \directory{material>raster\_data>SENTINEL1}. Despliege la banda \directory{Sigma\_HH\_db}.
...
Abra la imagen \path{ALOS} de la carpeta \directory{material>raster\_data>ALOS}. Despliege la banda \directory{Sigma\_HH\_db}.
...
Es habitual expresar el valor del coeficiente de backscatter en dB para las imágenes SAR. Para calcularlo en distintos sectores de la imagen puede posicionarse sobre un píxel y observar en \menu{Pixel info} el valor de \directory{Sigma\_HH\_db} en dB.
