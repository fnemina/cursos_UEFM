...
Obtengala usando \menu{Radar>Polarimetric>Polarimetric Decomposition} seleccionando como entrada la imagen corregida en terreno y la descomposición la de \texttt{Freeman-Durden Decomposition} en \texttt{Processing parametric} (Figura \ref{fig:pauli})
...
Obtengala usando \menu{Radar>Polarimetric>Polarimetric Decomposition} seleccionando como entrada la imagen corregida en terreno y la descomposición la de \texttt{H-A-Alpha Quadpole decomposition} en \texttt{Processing parametric} (Figura \ref{fig:pauli}). Seleccione la opcíon \texttt{Entropy(H), Anisotropy (A), Alpha}.
