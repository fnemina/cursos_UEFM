...
Existen otros filtros que ayudan a disminuir el ruido de la imagen. Uno de los más comunes es  \menu{Lee Sigma}, que se encuentra en \menu{Radar>Speckle Filter>Single Product Speckle Filter}.
...
En \menu{I/O Parameters}, \texttt{source} seleccione la imagen
\begin{center}
