...
En este caso se utilizará una herramienta que permite realizar operaciones matemáticas. Seleccione \menu{Raster>Band maths...} (Figura \ref{fig:bm}).
...
Asigne un nombre a la banda creada en la opción \emph{Name} y presione \emph{OK}, para finalizar.
