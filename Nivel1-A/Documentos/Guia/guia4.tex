...
\begin{enumerate}
  ...
  \begin{enumerate}
    ...
    \item Grafique las firmas espectrales utilizando las herramientas de la clase 2 y analice para cada cobertura la relación entre infrarrojo cercano y rojo.
  \end{enumerate}
