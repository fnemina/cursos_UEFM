...
A la izquierda de la pantalla aparecerá una lista de productos. Busque de ellos el del 13 de julio del 2017, del path 224 y el row 78. Haga click sobre \menu{Order scene} (Figura \ref{fig:descarga}).
...
Para hacerlo seleccione la imagen apilada y dirijasé a \menu{Raster > Subset}. En la pestañá \menu{Spatial subset} seleccione la pestaña \menu{Geo Coordinates} (Figura \ref{fig:subset}).
...
Es posible también hacer un subset de bandas eligiendolas de la pestaña \menu{Band subset}.

\section{Reproyección}
Para algunas aplicacione la proyección por defecto de la imagen puede no ser la más indicada. Para cambiar la proyección dirijasé a \menu{Raster > Geometric operations > Reprojection} (Figura \ref{fig:repro}).
