...
} del 13 de julio del 2017, pertenenciente al path 224 y el row 78. Haga click sobre \menu{Order scene}. (Figura \ref{fig:descarga})

\begin{figure}[h!]
    \centering
    \subfloat[]{\includegraphics[width=0.7\textwidth]{fig:descarga.png}}
    \\
...
\begin{figure}[h!]
    \centering
    \subfloat[]{\includegraphics[width=0.7\textwidth]{fig:descarga2.png}}
    \\
    \subfloat[]{\includegraphics[width=0.7\textwidth]{fig:descarga3.png}}
