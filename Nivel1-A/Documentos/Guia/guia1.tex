...
Para ver las tres en simultáneo haga click en \menu{Window>Tile Horizontally} mostrándose de esa manera las imágenes vinculadas una junto a la otra. Moverse o hacer zoom en una imagen lo reproducirá en las otras. Para volver al modo habitual haga click en \menu{Window>Tile Single} (Figura \ref{fig:multiples}).
