...
\begin{figure}[h!]
    \centering
    \subfloat[1-I/O Parameters]{\includegraphics[width=0.4\textwidth]{fig:stack1.png}\label{fig:kmeans1}}
    \hspace{1cm}
    \subfloat[Processing parameters]{\includegraphics[width=0.4\textwidth]{fig:stack3.png}\label{fig:kmeans2}}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.4\textwidth]{fig:stack1.png}
    \caption{}
    \label{fig:colman}
\end{figure}
...
\begin{figure}[h!]
    \centering
    \subfloat[1-I/O Parameters]{\includegraphics[width=0.4\textwidth]{fig:stack1.png}}
    \hspace{1cm}
    \subfloat[Processing parameters]{\includegraphics[width=0.4\textwidth]{fig:stack3.png}}
    \caption{}
    \label{fig:resclass}
\end{figure}
