...
\begin{frame}{}
  \begin{figure}
    \centering
    \includegraphics[width=0.7\textwidth]{fig:transmision.png}
...
\begin{frame}{}
  \begin{figure}
    \centering
    \includegraphics[width=0.7\textwidth]{fig:absorcion.png}
...
\begin{frame}{}
  \begin{figure}
    \centering
    \includegraphics[width=0.7\textwidth]{fig:refleccion.png}
...
\begin{frame}{}
  \begin{figure}
    ...
    \caption{Teoría aditiva del color.}
    \label{}
  \end{figure}
\end{frame}
