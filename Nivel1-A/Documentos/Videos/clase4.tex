...
\begin{frame}{}
  \begin{figure}
    \centering
    \subfloat[1-Color Real]{\includegraphics[width=0.4\textwidth]{fig:RGBim.jpg}}
    \hspace{1cm}
    \subfloat[2-Índice de vegetación]{\includegraphics[width=0.4\textwidth]{fig:NDVIim.jpg}}
