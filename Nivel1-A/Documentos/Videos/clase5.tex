...
\begin{frame}{}
  \begin{figure}
    \centering
    \includegraphics[width=0.4\textwidth]{fig:bidimensional.jpg}
...
\begin{frame}{}
  \begin{figure}
    \centering
    \includegraphics[width=0.4\textwidth]{fig:clasesespectrales.jpg}
    \caption{Espacio espectral bidimensional}
    \label{}
  \end{figure}
\end{frame}
...
\begin{frame}{}
  \begin{figure}
    \centering
    \includegraphics[width=0.6\textwidth]{fig:scaterplot.jpg}
    \caption{Espacio espectral bidimensional}
    \label{}
  \end{figure}
\end{frame}
...
\begin{frame}{}
\begin{block}{Métodos de clasificación}
  Supervisados\pause
...
\begin{frame}{}
  \begin{figure}
    \centering
    \includegraphics[width=0.6\textwidth]{fig:areasentrenamiento.jpg}
    \caption{Áreas de entrenamiento.}
    \label{}
  \end{figure}
\end{frame}
